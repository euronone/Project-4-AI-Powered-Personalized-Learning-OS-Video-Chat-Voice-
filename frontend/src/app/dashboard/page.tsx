    ...
    <div className="app-shell space-y-8">
      ...
      <section className="surface-card p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/video" className="inline-flex items-center gap-1 text-sm font-semibold text-slate-700 hover:text-slate-900">
                ...
                <div className="relative">
                  <div className="flex h-36 items-center justify-center bg-gradient-to-br from-slate-800 to-slate-950">
                    <img
                      ...
                      alt={rec.title}
                      className="subject-image h-full w-full object-cover opacity-70"
                    />
