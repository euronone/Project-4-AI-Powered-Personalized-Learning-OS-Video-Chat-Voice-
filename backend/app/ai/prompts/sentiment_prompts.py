def build_sentiment_prompt(
    ...
    """
    Builds the prompt utilized for interpreting a student's expression during learning.
    Args:
        image_description (str): Textual analysis, parameters, or direct references to an image frame.
    Returns:
